...
using MyOnionApi1.Application.Features.Positions.Commands.DeletePositionById;
using MyOnionApi1.Application.Features.Positions.Commands.UpdatePosition;
using MyOnionApi1.Application.Features.Positions.Queries.GetPositionById;
using MyOnionApi1.Application.Features.Positions.Queries.GetPositions;
using MyOnionApi1.WebApi.Extensions;
using System;
using System.Threading.Tasks;

// For more information on enabling Web API for empty projects, visit https://go.microsoft.com/fwlink/?LinkID=397860

namespace MyOnionApi1.WebApi.Controllers.v1
{
    [ApiVersion("1.0")]
